	...
	createClass$1(Input, [{
		...
		value: function render() {
			...
			return React__default.createElement(
				...
				React__default.createElement('input', { className: classes, name: this.props.name, placeholder: this.state.placeholder, type: this.state.type, value: this.props.value, onChange: this.props.onChange }),
				React__default.createElement(
					'span',
					{ className: textClass },
					this.state.message
