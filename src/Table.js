      ...
      <table className={classes}>
        {((this.props.headers && this.props.headers.length > 0) ||
          ...
          <thead>
            {this.props.title && (
              <tr>
                <th colSpan={colSpan} key="table_header_title_01">
                  {this.props.title}
                </th>
              </tr>
            )}
            {this.props.headers && this.props.headers.length > 0 && (
              <tr>
                {this.props.headers.map(function (header, index) {
                  return <th key={"table_header_" + index}>{header}</th>;
                })}
              </tr>
            )}
          </thead>
              ...
              return (
                ...
                >
                  {row.map(function (value, column) {
                    return (
                      <td key={"table_body_row_" + index + "_" + column}>
                        {value}
                      </td>
                    );
                  })}
        ...
        {this.props.footer && (
          <tfoot>
            <tr>
              <td colSpan={colSpan} key={"table_footer_01"}>
                {this.props.footer}
              </td>
            </tr>
          </tfoot>
